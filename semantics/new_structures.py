...
# Copyright (C) 2011-2012 Ian Perera, Kenton Lee, and Constantine Lignos
#
...
class NewLocationQuery(NewQuery):
    """Where queries"""

class NewStatusQuery(NewQuery):
    """Status queries"""

class NewEntityQuery(NewQuery):
    """Who/What queries"""
